...
<body>
    ...
    <div class="container">
        ...
        <div id="content">
            ...
            <hr style="margin: 50px 0; border: none; border-top: 1px solid #ff85a1; opacity: 0.3;">
            
            <h3>A thousand times over...</h3>
            <div id="thousand-loves" class="loves-box"></div>
        </div>
    </div>
